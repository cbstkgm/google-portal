...
const urunler_verisi = [
    ...
    { id: "g1_cal", name: "Takvim", pricing: "Ücretsiz & Ücretli", category: "Günlük Kullanım", short_description: "Zamanınızı ve etkinliklerinizi yönetin.", long_description: "Google Takvim, toplantı planlamak, etkinlik oluşturmak ve günlük programınızı takip etmek için kullanılan bir zaman yönetimi aracıdır. Gmail ve Meet ile tam entegre çalışır.", icon_name: "calendar_month", link_url: "https://calendar.google.com", tags: ["takvim", "planlama", "workspace", "zaman"], fun_fact: "Zeki asistan özelliği sayesinde Gmail'inize gelen uçuş ve otel rezervasyonları otomatik olarak Takvim'e eklenir." },
    ...
    { id: "g5a", name: "Sohbet", pricing: "Ücretsiz & Ücretli", category: "Günlük Kullanım", short_description: "Ekipler için mesajlaşma.", long_description: "Proje odaları (spaces) oluşturup ekibinizle veya arkadaşlarınızla doğrudan sohbet edebileceğiniz mesajlaşma platformu.", icon_name: "chat", link_url: "https://chat.google.com", tags: ["mesaj", "sohbet", "ekip"], fun_fact: "Eskiden Google Hangouts olarak biliniyordu." },
    ...
    { id: "g18", name: "Kaydedildi", pricing: "Ücretsiz & Ücretli", category: "Günlük Kullanım", short_description: "İnternette beğendiğiniz her şeyi biriktirin.", long_description: "Google Arama, Haritalar ve Görseller'de kaydettiğiniz bağlantıları, yerleri ve fotoğrafları kategoriler halinde saklayan merkez.", icon_name: "bookmark", link_url: "https://www.google.com/save", tags: ["kayıt", "koleksiyon", "yer imi", "favori"], fun_fact: "Kaydettiğiniz mekanları arkadaşlarınızla ortak bir koleksiyon haline getirip birlikte seyahat planı yapabilirsiniz." },
    ...
    // --- 7. İş & Pazarlama ---
    { id: "b1", name: "Google Ads", pricing: "Ücretsiz & Ücretli", category: "İş & Pazarlama", short_description: "Çevrimiçi reklam platformu.", long_description: "İşletmelerin Google Arama, YouTube ve web sitelerinde reklam vermesini sağlar. Arama Ağı ve Alışveriş reklamları gibi ağları içerir.", icon_name: "campaign", link_url: "https://ads.google.com/", tags: ["reklam", "pazarlama", "ticaret", "seo", "arama ağı"], fun_fact: "Google'ın gelirlerinin büyük bir çoğunluğu hâlâ Ads platformundan gelmektedir." },
    { id: "b2", name: "Google Analytics", pricing: "Ücretsiz & Ücretli", category: "İş & Pazarlama", short_description: "Detaylı web sitesi ve uygulama istatistikleri.", long_description: "Web sitenize veya uygulamanıza gelen ziyaretçilerin davranışlarını analiz etmek, trafiği izlemek için kullanılan araçtır.", icon_name: "analytics", link_url: "https://analytics.google.com/", tags: ["analitik", "veri", "rapor", "istatistik"], fun_fact: "2005 yılında Urchin Software şirketinin satın alınmasıyla temelleri atılmıştır." },
    ...
    { id: "h14", name: "Android Automotive", pricing: "Ücretsiz & Ücretli", category: "Donanım & OS", short_description: "Araçlara yerleşik Android işletim sistemi.", long_description: "Telefona ihtiyaç duymadan arabanın kendi beynine entegre edilmiş Google Haritalar, Asistan ve Play Store içeren işletim sistemi.", icon_name: "directions_car", link_url: "https://www.android.com/auto/built-in/", tags: ["araba", "işletim sistemi", "oto", "yerleşik"], fun_fact: "Klimayı açmak veya koltuk ısıtmasını ayarlamak için bile Google Asistan'ı kullanabilirsiniz." },
    { id: "h5", name: "Google Nest", pricing: "Ücretsiz & Ücretli", category: "Donanım & OS", short_description: "Akıllı ev asistanı ve cihazları.", long_description: "Akıllı hoparlörler, termostatlar, güvenlik kameraları ve ekranlardan oluşan Nest ailesi evinizi akıllı hale getirir.", icon_name: "nest_cam_iq", link_url: "https://store.google.com/category/connected_home", tags: ["akıllı ev", "iot", "hoparlör"], fun_fact: "Nest Termostatlar bugüne kadar milyonlarca kWh enerji tasarrufu sağlamıştır." },
    { id: "h9", name: "Google Home", pricing: "Ücretsiz & Ücretli", category: "Donanım & OS", short_description: "Akıllı ev yönetim merkeziniz.", long_description: "Evinizdeki ışıkları, kameraları, termostatları ve diğer tüm uyumlu akıllı cihazları tek bir ekrandan kontrol etmenizi sağlayan uygulama.", icon_name: "home", link_url: "https://home.google.com/", tags: ["ev", "akıllı ev", "iot", "yönetim"], fun_fact: "Rutinler oluşturarak 'Günaydın' dediğinizde ışıkların açılmasını, haberlerin okunmasını ve kahve makinesinin çalışmasını sağlayabilirsiniz." },
    { id: "h6", name: "Bul (Find My Device)", pricing: "Ücretsiz & Ücretli", category: "Donanım & OS", short_description: "Kayıp cihazlarınızı kolayca bulun.", long_description: "Kayıp Android telefonlarınızı, saatlerinizi veya kulaklıklarınızı harita üzerinde bulun ve uzaktan kilitleyin/sıfırlayın.", icon_name: "find_in_page", link_url: "https://www.google.com/android/find", tags: ["kayıp", "güvenlik", "cihaz", "takip"], fun_fact: "Eğer telefonunuz sessizdeyse bile bu servis sayesinde son ses çaldırabilirsiniz." },
    ...
    { id: "k14", name: "Chrome Web Mağazası", pricing: "Ücretsiz & Ücretli", category: "Keşif", short_description: "Tarayıcınız için uzantı ve temalar.", long_description: "Chrome tarayıcınıza reklam engelleyiciler, verimlilik araçları ve temalar ekleyebileceğiniz resmi uygulama mağazası.", icon_name: "local_mall", link_url: "https://chromewebstore.google.com/", tags: ["eklenti", "tarayıcı", "uzantı", "mağaza"], fun_fact: "Mağazada yer alan bazı eklentiler tek başlarına milyonlarca aktif kullanıcıya sahiptir." },
    ...
    { id: "ent8", name: "Kitaplar", pricing: "Ücretsiz & Ücretli", category: "Eğlence", short_description: "E-kitap ve sesli kitap mağazası.", long_description: "Milyonlarca dijital kitabı ve sesli kitabı satın alıp, tüm cihazlarınızda okuyabileceğiniz devasa kütüphane.", icon_name: "menu_book", link_url: "https://play.google.com/store/books", tags: ["kitap", "okuma", "e-kitap", "kütüphane"], fun_fact: "Kitap okurken bilmediğiniz bir kelimenin üzerine basılı tutarak anında sözlük anlamını veya çevirisini görebilirsiniz." },
